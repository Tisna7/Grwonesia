        ...
        <div class="glass-card p-4 border-amber-500/30 flex items-start gap-3">
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-slate-400">
                    ...
                    <code class="font-mono text-primary-300">WA_GATEWAY_URL</code>, dan <code class="font-mono text-primary-300">WA_GATEWAY_TOKEN</code> di .env.
                </p>
            </div>
        </div>
    @endunless
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div class="glass-card p-6">
            ...
            <form method="POST" action="{{ route('business.whatsapp.broadcast') }}" class="mt-4 space-y-3">
                @csrf
                <textarea name="body" rows="6" class="form-input" placeholder="Tulis pesan broadcast… Tip: buat draf otomatis lewat Marketing Center (tipe: Pesan Broadcast WA).">{{ old('body') }}</textarea>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-primary-400/5">
                        ...
                        @empty
                            <tr><td colspan="5" class="px-5 py-8 text-center text-xs text-slate-500">Belum ada pesan.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
