...
<body class="bg-purple-dark text-slate-100 min-h-screen font-sans selection:bg-purple-500 selection:text-white"
    ...
    <div class="bg-gradient-to-r from-purple-900 via-indigo-900 to-purple-900 border-b border-purple-500/20 py-2.5 px-4 text-xs font-medium">
        <div class="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-3">
            <div class="flex items-center gap-2">
                <span class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-semibold bg-purple-500/20 text-purple-300 border border-purple-400/30">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-20">
                ...
                <div class="hidden md:flex flex-1 max-w-md mx-8 relative">
                    <input type="text"
                           x-model="searchQuery"
                           placeholder="Cari produk UMKM, batik, kopi, kerajinan..."
                    ...
                    <button x-show="searchQuery" @click="searchQuery = ''" class="absolute right-3 top-3 text-purple-400 hover:text-white text-xs">
                        ✕
                    </button>
                </div>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <button @click="showAiDrawer = true" class="relative group px-3.5 py-2 rounded-xl bg-gradient-to-r from-purple-800/80 to-purple-600/80 hover:from-purple-700 hover:to-purple-500 text-white text-sm font-semibold border border-purple-400/30 transition shadow-md shadow-purple-900/40 flex items-center gap-2">
                    ...
                    <button @click="showCartDrawer = true" class="relative p-2.5 rounded-xl bg-purple-950/70 border border-purple-500/30 hover:border-purple-400 text-purple-200 transition">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2 text-xs">
                    <li><a href="#" @click.prevent="scrollToSection('katalog')" class="hover:text-purple-300">Cari Produk & Katalog UMKM</a></li>
                    <li><a href="#" @click.prevent="showAiDrawer = true" class="hover:text-purple-300">AI Shopping Assistant</a></li>
                    <li><a href="#" @click.prevent="scrollToSection('ai-gift')" class="hover:text-purple-300">AI Gift Recommendation</a></li>
                    <li><a href="#" @click.prevent="scrollToSection('ai-compare')" class="hover:text-purple-300">AI Product Comparison</a></li>
                    <li><a href="#" @click.prevent="showImpactModal = true" class="hover:text-purple-300">Impact Score Tracker</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-xs">
                    <li><a href="#" @click.prevent="openRolePreview('business')" class="hover:text-purple-300">Business Account (UMKM & Supplier)</a></li>
                    <li><a href="#" @click.prevent="openRolePreview('government')" class="hover:text-purple-300">Government Dashboard (Dinas & Pemda)</a></li>
                    <li><a href="#" @click.prevent="openRolePreview('superadmin')" class="hover:text-purple-300">Super Admin Center</a></li>
                </ul>
            </div>
        </div>
    </footer>
    ...
    <div x-show="showAiDrawer"
        ...
        <div @click.away="showAiDrawer = false" class="w-full max-w-md bg-purple-card border-l border-purple-500/30 h-full flex flex-col shadow-2xl">
            ...
            <div class="p-5 border-b border-purple-500/20 bg-purple-950/80 flex items-center justify-between">
                ...
                <button @click="showAiDrawer = false" class="p-1.5 rounded-lg text-purple-400 hover:text-white hover:bg-purple-800/50">✕</button>
            </div>
        ...
        <div @click.away="showCheckoutModal = false" class="w-full max-w-xl bg-purple-card border border-purple-500/30 rounded-2xl overflow-hidden shadow-2xl space-y-5 p-6">
            ...
            <div class="space-y-4 text-xs">
                <div>
                    ...
                    <textarea class="w-full p-2.5 rounded-xl bg-purple-950/80 border border-purple-500/30 text-purple-100" rows="2">Jl. Merdeka No. 45, Kebayoran Baru, Jakarta Selatan, 12110</textarea>
                </div>
    ...
    <div x-show="showRolePreviewModal"
        ...
        <div @click.away="showRolePreviewModal = false" class="w-full max-w-2xl bg-purple-card border border-purple-400/40 rounded-3xl p-6 space-y-5 shadow-2xl">
            ...
            <div class="p-4 rounded-xl bg-purple-900/30 border border-purple-500/20 text-xs text-purple-300 flex items-center justify-between">
                <span>⚡ <strong>Catatan:</strong> Pengembang sedang memfokuskan implementasi <strong>Role User (Fitur Utama)</strong> saat ini.</span>
            ...
            return {
                ...
                initApp() {
                    ...
                    if (this.products.length >= 2) {
                        ...
                        this.compareProduct2 = this.products[4]; // Kopi Klepon
                ...
                generateAiComparison() {
                    ...
                    this.aiCompareAnalysis = {
                        verdict: p1.price < p2.price ? `${p1.name} menawarkan harga lebih hemat, sedangkan ${p2.name} unggul di aroma specialty khas Bromo.` : `${p2.name} sangat disukai pencinta varian unik.`,
                        recommendation: p1.impact_score > p2.impact_score ? `Pilih ${p1.name} untuk Impact Score lebih tinggi!` : `Pilih ${p2.name} untuk aroma khas!`
                    };
                },
