...
<div class="space-y-8">
    ...
    <div x-show="activeTab === 'katalog'" class="p-6 sm:p-8 rounded-3xl bg-purple-card border border-purple-500/30 shadow-2xl glow-purple relative overflow-hidden">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center relative z-10">
            ...
            <div class="lg:col-span-4 p-5 rounded-2xl bg-gradient-to-br from-purple-950/90 via-purple-900/60 to-indigo-950/90 border border-purple-500/30 space-y-3 text-center shadow-xl">
                <div class="inline-flex items-center gap-1.5 text-[11px] font-bold text-purple-300 px-3 py-1 rounded-full bg-purple-900/60 border border-purple-500/30">
                    <svg class="w-3.5 h-3.5 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"/></svg>
                ...
                <button @click="activeTab = 'tracking'" class="w-full py-2 rounded-xl bg-purple-900/80 hover:bg-purple-800 border border-purple-400/30 text-purple-200 text-xs font-bold flex items-center justify-center gap-1.5 transition">
                ...
                <div class="p-6 rounded-2xl bg-purple-card border border-purple-500/30 space-y-4 shadow-lg">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        ...
                        <div class="flex flex-col md:items-end gap-2">
                            ...
                            <div class="flex flex-wrap items-center gap-2">
                                <button @click="openTracking(order)" class="px-3.5 py-2 rounded-xl bg-purple-900/60 hover:bg-purple-800 border border-purple-400/30 text-purple-200 font-bold text-xs transition flex items-center gap-1.5">
    ...
    <div x-show="activeTab === 'tracking'" class="space-y-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-purple-500/20 pb-4">
            <div>
                <span class="text-[10px] font-bold text-purple-400 uppercase tracking-widest">Customer Portal — Live Logistics</span>
                <h3 class="text-xl font-bold text-white font-heading flex items-center gap-2">
                    <svg class="w-6 h-6 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                    <span>Order Tracking (Pelacakan Pengiriman)</span>
                </h3>
                <p class="text-xs text-purple-300/70">Monitor progress pengiriman paket pesanan Anda secara real-time dengan dukungan prediksi AI.</p>
            </div>
            ...
            <template x-if="ordersHistory.length > 0">
                <div class="flex items-center gap-2 bg-purple-950/80 p-1.5 rounded-2xl border border-purple-500/30">
                    ...
                    <select x-model="trackingOrder" class="bg-purple-900 text-white text-xs font-bold rounded-xl px-3 py-1.5 border border-purple-400/30 focus:outline-none">
        ...
        <template x-if="trackingOrder">
            <div class="space-y-6">
                ...
                <template x-if="trackingOrder.shippingStatus === 'Delivered'">
                    <div class="p-5 rounded-2xl bg-emerald-950/80 border border-emerald-500/40 text-emerald-200 flex flex-col md:flex-row md:items-center justify-between gap-4 shadow-lg shadow-emerald-950/50">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <button @click="addToCart(products[0])" class="px-4 py-2 rounded-xl bg-purple-900 hover:bg-purple-800 text-purple-200 font-bold text-xs transition border border-purple-400/30">
                                Beli Lagi
                            </button>
                        </div>
                    </div>
                ...
                <div class="p-6 sm:p-8 rounded-3xl bg-purple-card border border-purple-500/30 shadow-2xl glow-purple relative overflow-hidden space-y-6">
                    <div class="flex flex-wrap items-center justify-between gap-4 border-b border-purple-500/20 pb-5">
                        <div class="flex items-center gap-4">
                            <!-- Courier Badge / Logo -->
                            <div class="w-14 h-14 rounded-2xl bg-gradient-to-tr from-purple-900 to-fuchsia-800 border border-purple-400/40 flex items-center justify-center text-white font-black text-sm tracking-wider shadow-lg">
                            ...
                            <div>
                                ...
                                <div class="flex items-center gap-2 mt-0.5">
                                    ...
                                    <span class="text-[10px] text-purple-400/60">• Updated <span x-text="trackingOrder.lastUpdated"></span></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-3">
                            <button @click="refreshTracking()" class="px-4 py-2.5 rounded-xl bg-purple-600 hover:bg-purple-500 text-white text-xs font-bold transition shadow-lg flex items-center gap-2">
                            ...
                            <button @click="copyTrackingNumber(trackingOrder.trackingNumber)" class="px-4 py-2.5 rounded-xl bg-purple-950 hover:bg-purple-900 border border-purple-500/40 text-purple-200 text-xs font-bold transition flex items-center gap-2">
                                <svg class="w-4 h-4 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z"/></svg>
                ...
                <div class="p-6 rounded-3xl bg-gradient-to-r from-purple-900/80 via-fuchsia-900/50 to-purple-950/90 border border-fuchsia-400/40 shadow-2xl glow-purple relative overflow-hidden space-y-3">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-2">
                            <div class="w-8 h-8 rounded-xl bg-fuchsia-500/20 border border-fuchsia-400/30 flex items-center justify-center text-fuchsia-300">
                    ...
                    <p class="text-xs text-purple-100 leading-relaxed" x-text="trackingOrder.aiInsight || 'Pengiriman berjalan lancar sesuai estimasi.'"></p>
                    ...
                    <div class="relative pl-8 space-y-6 border-l-2 border-purple-500/30 ml-4">
                        <template x-for="(step, idx) in trackingOrder.timeline" :key="'tl-step-'+idx">
                            <div class="relative group">
                                ...
                                <div class="space-y-1">
                                    <div class="flex flex-wrap items-center gap-2">
                                        <h5 class="text-xs font-bold" :class="step.done ? 'text-white' : 'text-purple-400/60'" x-text="step.desc"></h5>
                ...
                <div class="p-6 rounded-3xl bg-purple-card border border-purple-500/30 shadow-2xl space-y-4">
                    ...
                    <div class="flex items-center gap-4 p-3 rounded-2xl bg-purple-950/80 border border-purple-500/20">
                        <img :src="trackingOrder.productImage" class="w-16 h-16 rounded-xl object-cover border border-purple-400/30">
                        <div class="space-y-1">
        ...
        <template x-if="!trackingOrder || ordersHistory.length === 0">
            <div class="text-center py-20 p-8 rounded-3xl bg-purple-card border border-purple-500/20 space-y-4">
                <div class="w-20 h-20 rounded-3xl bg-purple-950 border border-purple-500/30 flex items-center justify-center mx-auto text-purple-400 shadow-xl">
                ...
                <div class="space-y-1">
                    ...
                    <p class="text-xs text-purple-300/70 max-w-md mx-auto">Anda belum memiliki transaksi pengiriman yang aktif. Silakan pilih produk dari katalog UMKM dan selesaikan pesanan Anda.</p>
                </div>
                <button @click="activeTab = 'katalog'" class="px-6 py-3 rounded-2xl bg-gradient-to-r from-purple-600 to-fuchsia-600 hover:from-purple-500 hover:to-fuchsia-500 text-white font-bold text-xs transition shadow-lg">
    ...
    <div x-show="copyToast" x-cloak class="fixed bottom-6 right-6 z-50 px-4 py-3 rounded-2xl bg-purple-900 border border-purple-400 text-white text-xs font-bold shadow-2xl flex items-center gap-2 animate-bounce">
