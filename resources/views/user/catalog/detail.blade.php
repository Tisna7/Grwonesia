        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          ...
          <div class="md:col-span-7 space-y-4">
            ...
            <div class="flex flex-wrap items-center gap-3 pt-2">
              ...
              <button @click="shareProductToWhatsapp(selectedProductDetail)"
                class="px-5 py-3.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs transition shadow-lg flex items-center gap-2"
                title="Bagikan Produk ini ke WhatsApp">
              ...
              <button @click="copyCurrentUrl()"
                class="px-4 py-3.5 rounded-xl bg-purple-950 hover:bg-purple-900 border border-purple-500/30 text-purple-200 font-bold text-xs transition flex items-center gap-1.5"
                title="Salin Link URL Produk">
