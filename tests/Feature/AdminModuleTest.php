...
class AdminModuleTest extends TestCase
{
  ...
  public function test_non_admin_roles_cannot_access_admin_pages(): void
  {
    ...
    $gov = User::factory()->create(['role' => 'government', 'status' => 'terverifikasi']);

    $this->get('/admin/dashboard')->assertRedirect('/login');
    $this->actingAs($business)->get('/admin/dashboard')->assertRedirect(route('business.dashboard'));
    $this->actingAs($gov)->get('/admin/dashboard')->assertRedirect(route('government.dashboard'));
  }
